...
#Hyperparameters
envSize = 128
H = 100 #100 #number of neurons in hidden layer
batch_number = 50 # 50 size of batches for training
learn_rate = .01
gamma = 0.99
            ...
            for step in xrange(max_steps):
                ...
                if done:
                    ...
                    for ix,grad in enumerate(tGrad):
                        gradBuffer[ix] += grad
                        print ("episode_number % batch_number", episode_number % batch_number)
